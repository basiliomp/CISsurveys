...
AGR - Para señalar todas las variables que han sido agregadas en nuestro trabajo y no proceden directamente del fichero proporcionado por el CIS.
...
☑ Combinei the variables 'Recuerdo.reciente' & 'Otro.recuerdo' in order to get a new variable capturing all the possible answers regarding interveews voting behaviour. 

☐ *Same for voting intention??* That would imply:
      ~~1. Check the question in each survey recording voting intention (manually from reading PDFs and into 'general' table)~~
